...
const users = [
  {
    caption: 'Martin Koparanov',
    // You will need to prepend the image path with your baseUrl
    // if it is not '/', like: '/test-site/img/image.jpg'.
    image: '/img/mk.jpg',
    infoLink: 'https://onestopjs.dev/en/',
    pinned: true,
  },
];
...
const siteConfig = {
  ...
  headerLinks: [
    {doc: 'first-steps/introduction', label: 'Docs'},
    // {doc: 'doc4', label: 'API'},
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Martin Koparanov`,
  ...
  // template. For example, if you need your repo's URL...
    repoUrl: 'https://github.com/onestopjs/gatsby-theme-localization',
};
